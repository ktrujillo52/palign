...
"*": {"A":"-3" , "R":"-3" , "N":"-4" , "D":"-4" , "C":"-2" , "Q":"-2" , "E":"-3" , "G":"-2" , "H":"-2" , "I":"-3" , "L":"-2" , "K":"-3" , "M":"-1" , "F":"1" , "P":"-4" , "S":"-3" , "T":"-2" , "W":"11" , "Y":"2" , "V":"-3" , "B":"-4" , "Z":"-3" , "X":"-2" , "*":"11"}
}
#Score alignment
penalty = int(0)
scores_list = []
...
if (os.path.isfile("alignment1.txt")):
	variable = "rm -f alignment1.txt"
	output = subprocess.check_output(["bash", "-c", variable])

with open("alignment1.txt", "a+") as text:
